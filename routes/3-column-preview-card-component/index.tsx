...
const Home = ({ route }: PageProps) => (
  <>
    <Head>
      <title>3 Column Preview Card Component {pageHeaderSuffix}</title>
    ...
    <main>
      ...
      <section class="animation-in">
        <div class="card card--sedans">
          ...
          <h2 class="t-bold">Sedans</h2>
          <p class="t-normal">
            Choose a sedan for its affordability and excellent fuel economy.
            Ideal for cruising in the city or on your next road trip.
          </p>
          <button
            class="t-normal inline-flex justify-center items-center"
            type="button"
          >
            Learn More
          </button>
