export const ThankYou = () => (
  <div class="thank-you animation-in">
    <svg
    ...
    <h2 class="t-denim form-title">Thank you!</h2>
    <p class="t-gray">
      Thanks for checking out my project! I hope you have fun playing with it :)
    </p>
    <p class="t-gray">
      More frontend mentor solutions at{" "}
      <a href="https://www.frontendmentor.io/profile/SppamLite" target="_blank">
        SppamLite
      </a>.
    </p>
  </div>
